...
class JobPostingsRecord extends FirestoreRecord {
  JobPostingsRecord._(
  ...
  static Stream<JobPostingsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => JobPostingsRecord.fromSnapshot(s));

  static Future<JobPostingsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => JobPostingsRecord.fromSnapshot(s));

  static JobPostingsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      JobPostingsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static JobPostingsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      JobPostingsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'JobPostingsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is JobPostingsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createJobPostingsRecordData({
...
class JobPostingsRecordDocumentEquality implements Equality<JobPostingsRecord> {
  const JobPostingsRecordDocumentEquality();

  @override
  bool equals(JobPostingsRecord? e1, JobPostingsRecord? e2) {
  ...
  @override
  int hash(JobPostingsRecord? e) => const ListEquality().hash([
        e?.employerId,
        e?.title,
        e?.description,
        e?.location,
  ...
  @override
  bool isValidKey(Object? o) => o is JobPostingsRecord;
}

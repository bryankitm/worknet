...
import 'add_association_model.dart';
export 'add_association_model.dart';

class AddAssociationWidget extends StatefulWidget {
  const AddAssociationWidget({super.key});

  static String routeName = 'AddAssociation';
  static String routePath = '/addAssociation';

  @override
  State<AddAssociationWidget> createState() => _AddAssociationWidgetState();
}

class _AddAssociationWidgetState extends State<AddAssociationWidget> {
  late AddAssociationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAssociationModel());

    _model.associationTextController ??= TextEditingController();
    _model.associationFocusNode ??= FocusNode();

    _model.roleTextController ??= TextEditingController();
    _model.roleFocusNode ??= FocusNode();

    _model.associationMTextController ??= TextEditingController();
    _model.associationMFocusNode ??= FocusNode();

    _model.roleMTextController ??= TextEditingController();
                                                                      ...
                                                                      'Associations':
                                                                        ...
                                                                        getAssociationFirestoreData(
                                                                          updateAssociationStruct(
                                                                            AssociationStruct(
                                                                              association: _model.associationTextController.text,
                                                                  ...
                                                                  ...mapToFirestore(
                                                                    {
                                                                      'Associations':
                                                                        ...
                                                                        getAssociationFirestoreData(
                                                                          updateAssociationStruct(
                                                                            AssociationStruct(
                                                                              association: _model.associationMTextController.text,
                                                                              role: _model.roleMTextController.text,
                                                                            ),
                                                                            clearUnsetFields:
                                                                                false,
                                                                          ),

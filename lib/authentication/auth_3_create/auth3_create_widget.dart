...
class Auth3CreateWidget extends StatefulWidget {
  ...
  static String routeName = 'auth_3_Create';
  static String routePath = '/auth3Create';
                                              ...
                                              Align(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    var careerProfileRecordReference =
                                                        CareerProfileRecord
                                                            .collection
                                                            .doc();
                                                    await careerProfileRecordReference
                                                        .set(
                                                            createCareerProfileRecordData());
                                                    _model.careerProfile =
                                                        CareerProfileRecord
                                                            .getDocumentFromData(
                                                                createCareerProfileRecordData(),
                                                                careerProfileRecordReference);

                                                    await currentUserReference!
                                                        .update(
                                                            createUsersRecordData(
                                                      role: 'User',
                                                      careerProfileRef: _model
                                                          .careerProfile
                                                          ?.reference,
                                                    ));

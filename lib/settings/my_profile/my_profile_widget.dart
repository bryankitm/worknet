...
class _MyProfileWidgetState extends State<MyProfileWidget> {
  ...
  void initState() {
    ...
    _model.textController9 ??=
        TextEditingController(text: valueOrDefault(currentUserDocument?.x, ''));
    ...
    _model.textController11 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.linkedln, ''));
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 10.0, 0.0, 10.0),
                                            child: Flex(
                                              direction: functions.flexDisplay(
                                              ...
                                              children: [
                                                            ...
                                                            if (selectedMedia !=
                                                                ...
                                                                selectedMedia.every((m) =>
                                                                    validateFileFormat(
                                                                        ...
                                                                        context))) {
                                                              safeSetState(() =>
                                                                  _model.isDataUploading_uploadDataV2 =
                                                                      true);
                                                              ...
                                                              if (selectedUploadedFiles
                                                                ...
                                                                safeSetState(
                                                                    () {
                                                                  _model.uploadedLocalFile_uploadDataV2 =
                                                                      selectedUploadedFiles
                                                                          .first;
                                                                  _model.uploadedFileUrl_uploadDataV2 =
                                                                      downloadUrls
                                                                          .first;
                                                                });
                                                                showUploadMessage(
                                                ...
                                                Visibility(
                                                  visible: _model.uploadedFileUrl_uploadDataV2 !=
                                                          '',
                                                  child: Container(
                                                    width: () {
                                                      if (MediaQuery.sizeOf(

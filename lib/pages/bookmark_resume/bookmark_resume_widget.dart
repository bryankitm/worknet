...
import 'bookmark_resume_model.dart';
export 'bookmark_resume_model.dart';

class BookmarkResumeWidget extends StatefulWidget {
  const BookmarkResumeWidget({super.key});

  static String routeName = 'BookmarkResume';
  static String routePath = '/bookmarkResume';

  @override
  State<BookmarkResumeWidget> createState() => _BookmarkResumeWidgetState();
}

class _BookmarkResumeWidgetState extends State<BookmarkResumeWidget> {
  late BookmarkResumeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookmarkResumeModel());

...
import 'hr_post_job_model.dart';
export 'hr_post_job_model.dart';

class HrPostJobWidget extends StatefulWidget {
  const HrPostJobWidget({super.key});

  static String routeName = 'HrPostJob';
  static String routePath = '/postJob';

  @override
  State<HrPostJobWidget> createState() => _HrPostJobWidgetState();
}

class _HrPostJobWidgetState extends State<HrPostJobWidget> {
  late HrPostJobModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HrPostJobModel());

    _model.jobTitleTextController ??= TextEditingController();
    _model.jobTitleFocusNode ??= FocusNode();

    _model.offeredSalaryTextController ??= TextEditingController();
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadData8uk =
                                                                  true);
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFiles_uploadData8uk =
                                                                  selectedUploadedFiles;
                                                              _model.uploadedFileUrls_uploadData8uk =
                                                                  downloadUrls;
                                                            });
                                                            showUploadMessage(
                                                                context,
                                                        ...
                                                        _model.uploadedPhotos =
                                                            _model
                                                                .uploadedFileUrls_uploadData8uk
                                                                .toList()
                                                                .cast<String>();
                                                        safeSetState(() {});
                                                      },

...
import 'update_projects_portfolio_widget.dart'
    show UpdateProjectsPortfolioWidget;
import 'package:flutter/material.dart';

class UpdateProjectsPortfolioModel
    extends FlutterFlowModel<UpdateProjectsPortfolioWidget> {
  ///  Local state fields for this page.

  ProjectsPortfolioStruct? projectPortfolio;
  void updateProjectPortfolioStruct(
      Function(ProjectsPortfolioStruct) updateFn) {
    updateFn(projectPortfolio ??= ProjectsPortfolioStruct());
  }

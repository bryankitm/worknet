...
import 'add_work_experience_model.dart';
export 'add_work_experience_model.dart';

class AddWorkExperienceWidget extends StatefulWidget {
  const AddWorkExperienceWidget({super.key});

  static String routeName = 'AddWorkExperience';
  static String routePath = '/addWorkExperience';

  @override
  State<AddWorkExperienceWidget> createState() =>
      _AddWorkExperienceWidgetState();
}

class _AddWorkExperienceWidgetState extends State<AddWorkExperienceWidget> {
  late AddWorkExperienceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddWorkExperienceModel());

    _model.employerTextController1 ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<JobCategoriesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<JobCategoriesRecord> addWorkExperienceJobCategoriesRecordList =
            snapshot.data!;
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FlutterFlowDropDown<
                                                                        String>(
                                                                      controller: _model
                                                                          .jobLevelValueController1 ??= FormFieldController<
                                                                              String>(
                                                                          null),
                                                                      options: [
                                                                        'Internship & Graduate',
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FlutterFlowDropDown<
                                                                        String>(
                                                                      controller: _model
                                                                          .countryValueController1 ??= FormFieldController<
                                                                              String>(
                                                                          null),
                                                                      options:
                                                                          functions
                                                                    ...
                                                                    FlutterFlowDropDown<
                                                                      ...
                                                                      controller: _model
                                                                          .categoryValueController ??= FormFieldController<
                                                                              String>(
                                                                          null),
                                                                      options: addWorkExperienceJobCategoriesRecordList
                                                                          .map((e) =>
                                                                              e.name)
                                                                          .toList(),
                                                                      onChanged:
                                                                    ...
                                                                    StreamBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return FlutterFlowDropDown<
                                                                            String>(
                                                                          controller: _model.jobSubCategoryValueController ??=
                                                                          ...
                                                                          onChanged:
                                                                              (val) async {
                                                                            safeSetState(() =>
                                                                                _model.jobSubCategoryValue = val);
                                                                            _model.updateWorkExperienceStruct(
                                                                              (e) => e..subCategory = _model.jobSubCategoryValue,
                                                                            );
                                                                            safeSetState(() {});
                                                                          },
                                                                          width:
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FlutterFlowDropDown<
                                                                        String>(
                                                                      controller: _model
                                                                          .workTypeValueController ??= FormFieldController<
                                                                              String>(
                                                                          null),
                                                                      options: [
                                                                        'Full Time',
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FlutterFlowDropDown<
                                                                        String>(
                                                                      controller: _model
                                                                          .monthlySalaryValueController1 ??= FormFieldController<
                                                                              String>(
                                                                          null),
                                                                      options: List<
                                                                          String>.from([

...
import '/index.dart';
import 'hr_post_job_widget.dart' show HrPostJobWidget;
import 'package:flutter/material.dart';

class HrPostJobModel extends FlutterFlowModel<HrPostJobWidget> {
  ...
  bool isDataUploading_uploadData8uk = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadData8uk = [];
  List<String> uploadedFileUrls_uploadData8uk = [];
  ...
  String? _offeredSalaryTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Offered Salary is required';
    }
  ...
  int? experienceValue;
  FormFieldController<int>? experienceValueController;
  ...
  void initState(BuildContext context) {
    ...
    offeredSalaryTextControllerValidator =
        _offeredSalaryTextControllerValidator;

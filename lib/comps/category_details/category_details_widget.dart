    ...
    return Column(
      ...
      children: [
        Align(
          ...
          child: StreamBuilder<JobCategoriesRecord>(
            stream: JobCategoriesRecord.getDocument(widget.categoryRef!),
            builder: (context, snapshot) {
              ...
              final profileCardJobCategoriesRecord = snapshot.data!;
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.categoryNameTextController ??=
                                          TextEditingController(
                                    text: profileCardJobCategoriesRecord.name,
                                  ),
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.descriptionTextController ??=
                                          TextEditingController(
                                    text: profileCardJobCategoriesRecord
                                        .description,
                                  ),
                                    ...
                                    children: List.generate(
                                      ...
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 10.0, 0.0),
                                        child: Text(
                                          wrapSubCategoriesRecord.subCatName,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(

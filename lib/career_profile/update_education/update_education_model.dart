...
import '/index.dart';
import 'update_education_widget.dart' show UpdateEducationWidget;
import 'package:flutter/material.dart';

class UpdateEducationModel extends FlutterFlowModel<UpdateEducationWidget> {
  ///  Local state fields for this page.

  bool? stillStudying = false;

  EducationStruct? education;
  void updateEducationStruct(Function(EducationStruct) updateFn) {
    updateFn(education ??= EducationStruct());
  }

...
import '/index.dart';
import 'hr_update_job_widget.dart' show HrUpdateJobWidget;
import 'package:flutter/material.dart';

class HrUpdateJobModel extends FlutterFlowModel<HrUpdateJobWidget> {
  ...
  bool isDataUploading_uploadDataUpdateimg = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadDataUpdateimg = [];
  List<String> uploadedFileUrls_uploadDataUpdateimg = [];

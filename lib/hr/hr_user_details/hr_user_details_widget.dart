...
import 'hr_user_details_model.dart';
export 'hr_user_details_model.dart';

class HrUserDetailsWidget extends StatefulWidget {
  const HrUserDetailsWidget({
    super.key,
  ...
  static String routeName = 'HrUserDetails';
  static String routePath = '/hrUserDetails';

  @override
  State<HrUserDetailsWidget> createState() => _HrUserDetailsWidgetState();
}

class _HrUserDetailsWidgetState extends State<HrUserDetailsWidget> {
  late HrUserDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HrUserDetailsModel());
    ...
    _model.salaryExpectationTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.userDoc?.employmentAvailability.salaryExpectation,
      '-',
    ));
    _model.salaryExpectationFocusNode ??= FocusNode();
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                  TextFormField(
                                                                controller: _model
                                                                    .salaryExpectationTextController,
                                                                focusNode: _model
                                                                    .salaryExpectationFocusNode,
                                                                autofocus:
                                                                    false,
                                                                readOnly: true,
                                                                obscureText:

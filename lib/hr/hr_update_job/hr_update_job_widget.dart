...
import 'hr_update_job_model.dart';
export 'hr_update_job_model.dart';

class HrUpdateJobWidget extends StatefulWidget {
  const HrUpdateJobWidget({
    super.key,
  ...
  static String routeName = 'HrUpdateJob';
  static String routePath = '/hrUpdateJob';

  @override
  State<HrUpdateJobWidget> createState() => _HrUpdateJobWidgetState();
}

class _HrUpdateJobWidgetState extends State<HrUpdateJobWidget> {
  late HrUpdateJobModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HrUpdateJobModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<JobPostingsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final hrUpdateJobJobPostingsRecord = snapshot.data!;
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            if (selectedMedia !=
                                                                ...
                                                                selectedMedia.every((m) =>
                                                                    validateFileFormat(
                                                                        ...
                                                                        context))) {
                                                              safeSetState(() =>
                                                                  _model.isDataUploading_uploadDataUpdateimg =
                                                                      true);
                                                              ...
                                                              if (selectedUploadedFiles
                                                                ...
                                                                safeSetState(
                                                                    () {
                                                                  _model.uploadedLocalFiles_uploadDataUpdateimg =
                                                                      selectedUploadedFiles;
                                                                  _model.uploadedFileUrls_uploadDataUpdateimg =
                                                                      downloadUrls;
                                                                });
                                                                showUploadMessage(
                                                                    context,
                                                            ...
                                                            _model.uploadedPhotos =
                                                                _model
                                                                    .uploadedFileUrls_uploadDataUpdateimg
                                                                    .toList()
                                                                    .cast<
                                                                        String>();
                                                            safeSetState(() {});
                                                                ...
                                                                return Stack(
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        _model.removeFromUploadedPhotos(
                                                                            uploadedImagesItem);
                                                                        safeSetState(
                                                                            () {});
                                                                      },
                                                ...
                                                if (hrUpdateJobJobPostingsRecord
                                                    .photos.isNotEmpty)
                                                  Padding(
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                controller: _model
                                                                    ...
                                                                    TextEditingController(
                                                                  text: hrUpdateJobJobPostingsRecord
                                                                      .location,
                                                                ),
                                                                focusNode: _model
                                                                    .locationFocusNode,
